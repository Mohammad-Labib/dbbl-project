...
export default function ExcelUploadSection({ onUploadSuccess }) {
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
            Import DBBL Accounts via Excel
          </h2>
          <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            Upload your structured Excel sheet (<code className="text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded font-mono text-xs">.xlsx</code> or <code className="text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded font-mono text-xs">.xls</code>) to instantly sync bulk account data directly with your MongoDB database.
          </p>
        </div>
          ...
          <div className="md:col-span-5 space-y-5 border-b md:border-b-0 md:border-r border-gray-100 pb-6 md:pb-0 md:pr-6">
            ...
            <ul className="space-y-3.5 text-xs md:text-sm text-gray-600">
              <li className="flex items-start gap-3">
                ...
                <span>First row should contain correct column headers (e.g. <strong>Account Number</strong>, <strong>Name of A/C Holder</strong>).</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="p-1 bg-emerald-100 text-emerald-700 rounded-full mt-0.5 flex-shrink-0">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Ensure account numbers are formatted cleanly without extra spaces.</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="p-1 bg-emerald-100 text-emerald-700 rounded-full mt-0.5 flex-shrink-0">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-4 bg-emerald-50/60 rounded-2xl border border-emerald-100 flex items-center gap-3">
              ...
              <p className="text-xs text-emerald-800 font-medium">
                Data will be merged immediately upon successful upload.
              </p>
            </div>
          </div>
